...
namespace ClsParallel
{
    ...
    /// </para></remarks>
    ///
    public sealed class clsParallel
    {
        /// <summary>
        ...
        private static int threadsCount = System.Environment.ProcessorCount - 1;
        // object used for synchronization
        private static object sync = new Object();

        // single instance of the class to implement singleton pattern
        private static volatile clsParallel instance = null;
        ...
        /// <summary>Number of threads used for parallel computations.</summary>
        /// <remarks><para>The property sets how many worker threads are created for paralleling loops' computations.</para>
        /// <para>By default the property is set to number of CPU's in the system (see <see cref="System.Environment.ProcessorCount"/>).</para>
        /// </remarks>
        ...
        private static clsParallel Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new clsParallel();
                    instance.Initialize();
                }
                else
                {
